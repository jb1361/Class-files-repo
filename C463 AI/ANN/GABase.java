 ...
 * Last Modified Jan 29, 2018, 5:25PM
 * GABASE v2.0
...
/**
 * Class GABase implements Base class for all GAs. 
...
public class GABase{
    ...
    public static double rMax = 1.0;
    
    /** minimum limit of radius, default is 5.0 */
    public static double rMin = 0.0;
    
    
    /** length of an individual, default is 2560 */
    public static int length = 2560;
   ...
   // public boolean getGAVisual(){
    ...
    public void outputPopulation(PrintWriter out){
